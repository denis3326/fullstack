...
<html lang="en">
    <head>
        <?php include './code/registerC.php'; ?>
        <meta charset="utf-8" />
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input name="create" type="submit" class="btn btn-primary btn-block" value="Create Account"></div>
                                            </div>
                                            <p class="succsess">not corecct</p>
                                        </form>
                                    </div>
